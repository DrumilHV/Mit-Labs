...
int main() {
    int width = 8;   // Width of the input and output arrays
    int height = 8;  // Height of the input and output arrays

    int input[8][8]; // Input array
    int mask[3][3] = {{-1, -1, -1},
                      {-1,  8, -1},
                      {-1, -1, -1}}; // 3x3 convolution mask

    int output[8][8]; // Output array
